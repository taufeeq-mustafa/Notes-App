...
import NoDataImg from "../../assets/images/no.svg";
...
const Home = () => { 
  ...
  const deleteNotes=async(noteData)=>{ 
  ...
  return (
    ...
    <div className="container mx-auto">
      ...
      message={isSearch ? 'Oops! No data found matching your search.':'Start Creating your notes. Click on the blue Add icon on botton right to begin!'}/>
    )}
    ...
    onClick={()=>{
      ...
      <MdAdd className="text-[32-px] text-white"/>
    </button>
