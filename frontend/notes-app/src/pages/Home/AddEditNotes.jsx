  ...
  return (
    <div className="relative">
        ...
        <div className="flex flex-col gap-2">
         ...
         <input className="text-2xl text-slate-950 outline-none" type="text" placeholder="Go to gym at five" value={title} onChange={({target})=>setTitle(target.value)}/>
        </div>
        ...
        <div className="flex flex-col gap-2 mt-4">
            ...
            placeholder="Content"
            rows={10}  value={content} onChange={({target})=>setContent(target.value)}/>
        </div>
        <div className="mt-3">
